...
class Config:
    ...
    def dot_str(self, depth=0):
        ...
        for key in vars(self.__class__):
            ...
            dots = '.' * (Config.DOTS_WIDTH - len(key) - (depth * indent_width))
...
class TrainingConfig(Config):
    ...
    This is a top-level configuration that exposes subconfigurations through properties.
